...
class WorkforceController:
    def __init__(self):
        file_name = 'C:/Users/DESOUR10/Documents/929358.xlsx' # Escolhe o diretório do arquivo (Precisa só selecionar o diretório e fazer um loop para pegar todos os arquvivos da pasta)
        df = pd.read_excel(file_name) # Lê o arquivo

        columns = ['Data Acesso', 'Hora Acesso'] # Escolhendos as colunas precisam ser lidas
        #print(df)

        dataI = '09012024' # Data para verificar ## O Usuário vai precisar inserir
